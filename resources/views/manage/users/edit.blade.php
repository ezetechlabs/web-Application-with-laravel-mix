  ...
  <div class="flex-container">
    ...
    <form action="{{route('users.update', $user->id)}}" method="POST">
        ...
        <div class="column">
          ...
          <div class="field">
            ...
            <b-radio-group v-model="password_options">
              ...
              <div class="field">
                <b-radio name="password_options" value="auto">Gener&eacute automatiquement le mot de passe</b-radio>
              </div>
              <div class="field">
                <b-radio name="password_options" value="manual">Ecrire le mote de passe manuelement</b-radio>
                <p class="control">
      ...
      <div class="columns">
        <div class="column">
          <hr />
          <button class="button is-primary is-pulled-right" style="width: 250px;">Editer un User</button>
        </div>
      </div>
    </form>
